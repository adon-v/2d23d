...
module FactoryImporter
  ...
  def self.import_factory_layout
    ...
    begin
      ...
      # 先生成地面，再区域着色
      ZoneBuilder.generate_factory_total_ground(main_group, all_zones,all_walls) if defined?(ZoneBuilder.generate_factory_total_ground)
      ZoneBuilder.generate_zones_floor(main_group, all_zones) if defined?(ZoneBuilder.generate_zones_floor)
